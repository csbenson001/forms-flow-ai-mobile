...
class CryptoUtils {
  static String encryptAESCrypt(String plainText) {
    try {
      final salt = genRandomWithNonZero(8);
      var keyndIV =
          deriveKeyAndIV(FormsFlowAIConstants.webSocketEncryptKey, salt);
  ...
  static String decryptAESCrypt(String encrypted, String passphrase) {
    try {
