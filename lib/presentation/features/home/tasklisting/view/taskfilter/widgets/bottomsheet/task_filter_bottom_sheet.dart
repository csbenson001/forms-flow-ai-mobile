...
/// [TaskFiltersBottomSheetView] to build a bottom sheet for displaying
/// sort filters
class TaskFiltersBottomSheetView extends BaseConsumerWidget {
  const TaskFiltersBottomSheetView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
          ...
          middle: Text(
            Strings.taskListingLabelFilter,
