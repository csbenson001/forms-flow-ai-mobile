...
class FilterInflateLikeEqOperatorViews extends BaseConsumerWidget {
  const FilterInflateLikeEqOperatorViews(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: CustomTextFormField(
                      initialValue: taskFilterDM.selectedVariableValue ?? "",
                      onChanged: (value) {
                        ref
                            .read(taskListViewModelProvider)
                            .updateSelectedVariableValue(
                                taskFilterDM, index, value);
                      },
                      hint: "Value",
                      enabled: taskFilterDM.enableEditing,
