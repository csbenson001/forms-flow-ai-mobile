...
mixin _$FormSubmissionResponse {
  ...
  @JsonKey(ignore: true)
  $FormSubmissionResponseCopyWith<FormSubmissionResponse> get copyWith =>
...
/// @nodoc
@JsonSerializable()
class _$_FormSubmissionResponse implements _FormSubmissionResponse {
  const _$_FormSubmissionResponse(
  ...
  @override
  String toString() {
    return 'FormSubmissionResponse(id: $id, form: $form, owner: $owner, roles: $roles, access: $access, metadata: $metadata, data: $data, externalIds: $externalIds, created: $created, modified: $modified, state: $state)';
  }
