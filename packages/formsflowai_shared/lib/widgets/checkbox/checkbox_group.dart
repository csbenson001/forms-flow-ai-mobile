...
class GroupedCheckbox extends StatefulWidget {
  ...
  const GroupedCheckbox(
      ...
      required this.chechBoxWidth,
      required this.chechBoxHeight});
...
class _GroupedCheckboxState extends State<GroupedCheckbox> {
  List<String>? selectedListItems = List<String>.empty(growable: true);
  ...
  Widget item(int index) {
    return Padding(
        ...
        child: Row(
          ...
          children: <Widget>[
            SizedBox(
              width: widget.chechBoxWidth,
              height: widget.chechBoxHeight,
              child: Checkbox(
              ...
              child: Text(
                ...
                style: widget.disabled != null &&
                        widget.disabled!
                            .contains(widget.itemList.elementAt(index))
                    ? TextStyle(
                        color: Theme.of(context).disabledColor, fontSize: 8.0)
                    : widget.textStyle,
              ),
            )
          ],
